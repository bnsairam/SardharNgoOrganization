      ...
      <nav className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Button size="lg" onClick={() => scrollToSection("donate")} className="shadow-lg hover:shadow-xl">
              Donate Now
            </Button>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-20 left-0 right-0 bg-background shadow-lg border-t animate-slide-in">
            <div className="container mx-auto px-4 py-6 flex flex-col gap-4">
              ...
              <Button size="lg" className="w-full shadow-lg" onClick={() => scrollToSection("donate")}>
                Donate Now
              </Button>
            </div>
          </div>
